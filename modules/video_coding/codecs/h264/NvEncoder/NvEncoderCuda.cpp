...
int32_t NvEncoderCuda::Initialize(CUcontext cuContext,
                                  uint32_t nWidth,
                                  uint32_t nHeight,
  ...
  NVENC_API_CALL(NvEncoder::Initialize(
      NV_ENC_DEVICE_TYPE_CUDA, cuContext, nWidth, nHeight, eBufferFormat,
...
int32_t NvEncoderCuda::AllocateInputBuffers(int32_t numInputBuffers) {
...
int32_t NvEncoderCuda::SetIOCudaStreams(NV_ENC_CUSTREAM_PTR inputStream,
...
int32_t NvEncoderCuda::CopyToDeviceFrame(CUcontext device,
                                         void* pSrcFrame,
                                         uint32_t nSrcPitch,
